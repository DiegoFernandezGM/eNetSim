...
class Network:
    ...
    def calculate_emissions(self):
        ...
        for subsystem_name, energy_consumptions in energy_consumption_results.items():
            subsystem_emissions = 0
            for energy_consumption in energy_consumptions:
                emission_factor = self.get_emission_factor()
                subsystem_emissions += energy_consumption * emission_factor
            
            print(f"{subsystem_name}: {round(subsystem_emissions, 2)} kg CO2")
            total_emissions += subsystem_emissions
